...
Vue.component('todo-list', {
  template: '<ul><li class="comment" v-for="todo in todos"><div class="cell1"><div class="photo"> <img src="images/profil.jpg" alt="profil picture"></div></div><div class="isi-comment"><h1>Safa Kalila</h1><p>{{todo}}</p><p>a few seconds ago</p></div></li></ul>',
  props: ['todos']
});
new Vue({
  el: '#app',
...
$(".main").onepage_scroll({
   ...
   easing: "cubic-bezier(0.175, 0.885, 0.420, 1.210)",                  // Easing options accepts the CSS3 easing animation such "ease", "linear", "ease-in",
